...
import CronSidebar from '@/components/dashboard/cron/CronSidebar';

/**
 * Shared chrome for every /cron/* route (the reminder-monitoring section).
 *
 * Left: fixed icon sidebar (Daily Reminder | Hourly Reminder + Logout). Right:
 * a header band + the active reminder table.
 *
 * Auth is enforced by middleware — unauthenticated requests redirect to '/'.
 * All data flows through /api/cron/* routes (service-role only).
 */
